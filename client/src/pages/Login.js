...
const styles = (theme) => ({
  root: {
    ...
    alignItems: "center",
    background:
      "url('https://s1.1zoom.ru/b5348/64/Tomatoes_Garlic_Spices_Pasta_Plate_Fork_519009_3840x2160.jpg') no-repeat",
        ...
        <Card className={classes.card}>
          <CardContent>
            ...
            <Typography component="p">
              To start please Log In. If you do not have an account please Sign
              Up
            </Typography>
          </CardContent>
